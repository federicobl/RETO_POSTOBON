...
<body class="index2">
        ...
        <div id="demo"><h1 style="color:black"> Materiales <h1></div>
        ...
        <tr><th> Nombre </th><th>Caracteristicas</th><th>Tipo de Material</th></tr>
        <?php
        include('db.php');
        ...
        <tr>
            ...
            <td><?php echo $mostrar['TipoMaterialId']?></td>
        </tr>
    <?php
        }
        ?>    
